...
- `npm run test:e2e` runs local Playwright smoke checks for anonymous entry, keyboard movement, gem collection, loss, level completion, replay, and the 3-attempt repeat-play target; CI still runs lint and build only.
