...
These checks are intentionally local-only for now. They verify anonymous entry, keyboard movement, gem collection, loss, and level completion; CI still runs lint and build only.
